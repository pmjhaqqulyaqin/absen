...
/* ===== REKAP PER KELAS (untuk pill kelas) ===== */
$rekap_per_kelas = [];
...
if ($kelas) {
    $res = $conn->query("
        ...
        WHERE a.tanggal='$tanggal' AND a.kelas='$kelas'" . periode_where($conn, 'a.') . "
        ORDER BY a.nama
    ");
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:14px">
            ...
            <a href="?tanggal=<?= $tanggal ?>&kelas=<?= urlencode($k) ?>"
               style="display:inline-flex;align-items:center;gap:7px;padding:9px 18px;border-radius:999px;
                ...
                <i class="fas fa-<?= $done ? 'check-circle' : 'pen-square' ?>" style="font-size:.85rem"></i>
