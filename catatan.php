...
if ($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['save_catatan'])) {
    ...
    list($ptaC, $psemC) = periode_values($conn);
    $conn->query("INSERT INTO catatan (siswa_id,wali_id,tipe,judul,isi,tahun_ajaran,semester) VALUES ($sid,NULL,'$tipe','$judul','$isi',$ptaC,$psemC)");
...
$where=$filter_siswa?"WHERE c.siswa_id=$filter_siswa":'WHERE 1=1';
$where .= periode_where($conn, 'c.');
