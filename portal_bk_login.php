...
// Catatan: tidak ada seed otomatis di sini lagi — data Guru BK sepenuhnya
// dikelola dari menu Kelola PIN Login (Tambah BK / Hapus), supaya penghapusan
// permanen dan tidak muncul lagi sendiri.
...
<div class="card">
    <div class="card-top">
        ...
        <p>Sistem Monitoring Siswa Digital</p>
    ...
    <div class="card-body">
        ...
        <a href="<?= BASE_URL ?>index.php" class="back-link"><i class="fas fa-arrow-left"></i> Kembali ke Beranda</a>
    </div>
</div>
<script>
