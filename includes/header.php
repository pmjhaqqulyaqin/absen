...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?= BASE_URL ?>assets/pwa/pwa-icon-192x192.png">

    <!-- PWA: Web App Manifest & Apple Touch Icon -->
    <link rel="manifest" href="<?= BASE_URL ?>manifest.json">
    <link rel="apple-touch-icon" sizes="180x180" href="<?= BASE_URL ?>assets/pwa/pwa-icon-180x180.png">
    ...
    <!-- PWA: Early capture of install prompt + Service Worker -->
    <script>
