...
// Stats
$stats = $conn->query("SELECT status, COUNT(*) as total FROM absensi WHERE tanggal='$tanggal'" . ($kelas?" AND kelas='$kelas'":'') . periode_where($conn) . " GROUP BY status")->fetch_all(MYSQLI_ASSOC);
